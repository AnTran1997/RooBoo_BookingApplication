...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Room room1= new Room("01 Nguyễn Đình Chiểu, Quận 1, TP HCM",R.drawable.img_hotel1,"Forest Dream","745.000","120 người bình luận","x3","x3" );
        Room room2= new Room("18/8 Trần Hưng Đạo, Quận 1, TP HCM",R.drawable.img_hotel2,"ACB Hotel","500.000","60 người bình luận","x2","x2" );
